//list of keywords made from business categories from https://www.yelp.com/developers/documentation/v3/all_category_list
...
const keywordList = [
   ...
   'Australian',
   'Austrian',
   'Authorized Postal Representative',
   'Auto Detailing',
   'Auto Customization',
   'Car Inspectors',
   ...
   'Internal Medicine',
   'International',
   'Internet Booths & Calling Centers',
   'Internet Cafes',
